...
with_node \
  ...
  --target "/Users/justinroderick/Developer/reactApps/POOSD/LargeProject/apps/mobile/ios/Pods/Target Support Files/Pods-mobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-file-system" "expo-keep-awake" "expo-router"
